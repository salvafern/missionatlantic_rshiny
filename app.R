...
server <- function(input, output, session) {
  ...
  output$textEco <- renderUI(quoted = FALSE,
                               if(is.null(input$outputEcoType) || is.null(input$Nutrient_Phytoplankton_Tab) ){# && is.null(input$Zooplankton_Tab) && is.null(input$Fish_Tab) && is.null(input$Benthos_Tab) && is.null(input$Predators_Tab) && is.null(input$Corpse_Discard_Tab) && is.null(input$Macrophyte_Tab)){
                                 ...
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the organic detritus and bacteria content of  seabed sediments of the inshore zone. s1 = muddy sediment, s2 = sandy, s3 = gravelly. Units: Grams of organic nitrogen per gram of dry sediment, expressed as a percentage"))}
                               else if(input$outputEcoType == "Sediment" && input$Sediment_Tab == "sedOffDetrius"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the organic detritus and bacteria content of  seabed sediments of the offshore zone. d1 = muddy sediment, d2 = sandy, d3 = gravelly. Units: Grams of organic nitrogen per gram of dry sediment, expressed as a percentage"))}
                               else if(input$outputEcoType == "Sediment" && input$Sediment_Tab == "sedInCorpses"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of dead animals  (from plankton to whales) in the seabed habitats of the inshore zone. s1 = muddy sediment, s2 = sandy, s3 = gravelly. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 0.5 grams of material per m<sup>2</sup>"))}
                               else if(input$outputEcoType == "Sediment" && input$Sediment_Tab == "sedOffCorpses"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of dead animals  (from plankton to whales) in the seabed habitats of the offshore zone. d1 = muddy sediment, d2 = sandy, d3 = gravelly. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 0.5 grams of material per m<sup>2</sup> "))}
                               else if(is.null(input$outputEcoType) || is.null(input$Zooplankton_Tab)){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of omnivorous zooplankton in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))} 
                                 ...
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of carnivorous zooplankton in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))} 
                               else if(is.null(input$outputEcoType) || is.null(input$Fish_Tab)){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of planktivorous (plankton-eating) fish in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Fish" && input$Fish_Tab == "plankFish"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of planktivorous (plankton-eating) fish in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Fish" && input$Fish_Tab == "plankFishLarv"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of larvae of planktivorous (plankton-eating) fish in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Fish" && input$Fish_Tab == "demFish"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of demersal (benthos and fish-eating) fish in the inshore and offshore zones.Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Fish" && input$Fish_Tab == "demFishLarv"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of larvae of demersal (benthos and fish-eating) fish in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
                               else if(is.null(input$outputEcoType) || is.null(input$Benthos_Tab)){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of suspension and deposit feeding benthos (seabed -living invertebrate animals) in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight per km<sup>2</sup> of seabed"))}
                                 ...
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of planktonic larvae of suspension and deposit feeding benthos (seabed -living invertebrate animals) in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1  km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Benthos" && input$Benthos_Tab == "benCarnFeed"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of carnivorous and scavenge feeding benthos (seabed -living invertebrate animals) in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight per km<sup>2</sup> of seabed"))}
                               else if(input$outputEcoType == "Benthos" && input$Benthos_Tab == "benCarnLarvFeed"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of planktonic larvae of carnivorous and scavenge feeding benthos (seabed -living invertebrate animals) in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1  km<sup>2</sup> of sea surface"))}
                               else if(is.null(input$outputEcoType) || is.null(input$Predators_Tab)){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of seabirds in the inshore and offshore zones. Units: 0.01 milli-Mole of nitrogen per m<sup>2</sup> (0.01 mMN.m<sup>-2</sup>) is approximately equivalent to 5 kg of live weight per km<sup>2</sup> of sea surface"))}
                                 ...
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of pinnipeds (seals) in the inshore and offshore zones. Units: 0.01 milli-Mole of nitrogen per m<sup>2</sup> (0.01 mMN.m<sup>-2</sup>) is approximately equivalent to 5 kg of live weight per km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Predators" && input$Predators_Tab == "predCetaceans"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of cetaceans (whales) in the inshore and offshore zones. Units: 0.01 milli-Mole of nitrogen per m<sup>2</sup> (0.01 mMN.m<sup>-2</sup>) is approximately equivalent to 5 kg of live weight per km<sup>2</sup> of sea surface"))}
                               else if(input$outputEcoType == "Predators" && input$Predators_Tab == "predMigFish"){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of migratory fish in the inshore and offshore zones. Migratory fish spend only part of the year in the model region. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
                               else if(is.null(input$outputEcoType) || is.null(input$Corpse_Discard_Tab)){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of dead animals  (from plankton to whales) in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of material below 1 km<sup>2</sup> of sea surface"))}
                                 ...
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of dead fish discarded by fishing vessels in the inshore and offshore zones. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of material below 1 km<sup>2</sup> of sea surface"))}
                               else if(is.null(input$outputEcoType) || is.null(input$Macrophyte_Tab)){
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of macrophytes (large seaweeds) in the inshore zone. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup>  of sea surface"))}
                                 ...
                                 fluidRow(HTML("<p style = \"font-family: 'calibri'; font-si10pt \">Changes over the year in the quantity of macrophyte debris (dead, broken-off pieces off seaweed) in the inshore zone. Units: 1 milli-Mole of nitrogen per m<sup>2</sup> (1 mMN.m<sup>-2</sup>) is approximately equivalent to 500 kg of live weight below 1 km<sup>2</sup> of sea surface"))}
