...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","planktivorousFish.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Quota_limited_Demersal_fish.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Non_quota_demersal_fish.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Migratory_fish.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Susp_deposit_feeding_benthos.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Carn_scavebge_feeding_benthos.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Pelagic_invertebrates.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","birds.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Pinnipeds.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Cetaceans.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","Macrophytes.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGuildOutput","_","All_guilds_combined.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Pelagic_Trawl_Seine.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Sandeel_sprat_trawl_Otter30_70mm_TR3.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Otter30_70mm_TR3_sandeel_sprat.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Longline_mackerel.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Beam_Trawl_BT1BT2.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Demersal_Seine.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Demersal_Otter_Trawl_TR1.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Gill_Nets_Longline_demersal.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Beam_Trawl_shrimp.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Nephrops_Trawl_TR2.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Creels.png"))
...
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Mollusc_Dredge.png"))
...
if(selectedLocation == "North_Sea"){
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","Whaler.png"))
...
if(selectedLocation == "Celtic_Sea"){
png(filename = paste0(selectedLocation, "_" ,selectedVariant, "_", "CatchPerGearOutput","_","KelpHarvester.png"))
